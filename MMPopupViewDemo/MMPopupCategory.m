...
- (void)mm_showDimBackground
{
    ...
    if ( self == [MMPopupWindow shareWindow].attachView )
    {
        [MMPopupWindow shareWindow].hidden = NO;
        [[MMPopupWindow shareWindow] makeKeyAndVisible];
    }
    ...
    [UIView animateWithDuration:self.mm_dimAnimationDuration
                     ...
                     animations:^{
                         ...
                         if ( finished )
                         {
                             ...
                             if ( self == [MMPopupWindow shareWindow].attachView )
                             {
                                 [MMPopupWindow shareWindow].hidden = YES;
